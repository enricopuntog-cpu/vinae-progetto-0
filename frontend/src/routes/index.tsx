...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Il marketplace sociale italiano per il vino tra privati." },
          ...
          >
            {isGuest ? (
              <>
                ...
                >
                  <Link to="/esplora">Esplora come ospite</Link>
                </Button>
              </>
            ) : (
              <>
                ...
                >
                  <Link to="/cantina">Crea la tua cantina</Link>
                </Button>
              </>
            )}
          </div>
