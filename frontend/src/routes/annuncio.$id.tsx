...
export const Route = createFileRoute("/annuncio/$id")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    if (!loaderData)
      return {
        meta: [{ title: "Annuncio non trovato — Vinea" }, { name: "robots", content: "noindex" }],
      };
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: wine.immagini[0] },
        { name: "twitter:image", content: wine.immagini[0] },
      ],
    };
  },
  notFoundComponent: () => (
            ...
            <div className="mt-4 rounded-xl border border-oro/40 bg-oro/10 p-3 text-sm">
              ...
              {propostaAttiva.stato === "controproposta" && (
                <>
                  ...
                  <Link to="/messaggi" className="text-bordeaux underline">
                    Rispondi in chat
                  </Link>
                  .
                </>
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate({
                        to: "/checkout/$id",
                        params: { id: wine.id },
                        search: { prop: propostaAttiva.id, q: undefined },
                      })
                    }
                  >
                    Vai al checkout
            ...
            <Button
              ...
              onClick={() =>
                navigate({
                  to: "/checkout/$id",
                  params: { id: wine.id },
                  search: { prop: undefined, q: undefined },
                })
              }
            >
              Compra ora
    ...
    <div className="mt-4 rounded-2xl border border-oro/40 bg-oro/10 p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <Button asChild size="sm" variant="ghost">
          <Link to="/cantina">Sposta nella cantina</Link>
        </Button>
      </div>
    </div>
  );
