...
import { discussions } from "@/data/communities";
...
export const Route = createFileRoute("/home")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Home utente — Vinea" },
      {
        property: "og:description",
        content: "Bottiglie consigliate, ribassi sui preferiti e attività community.",
      },
    ],
  }),
  ...
  return (
    <div className="space-y-10">
      <section className="rounded-3xl bg-gradient-to-br from-bordeaux via-bordeaux to-antracite p-6 text-crema md:p-10">
        <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-end">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              <Link to="/cantina">Apri cantina</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section>
        <SectionTitle
          action={
            <Link to="/esplora" className="text-sm font-medium text-bordeaux hover:underline">
              Vedi tutto →
            </Link>
          }
        >
      ...
      <section>
        <SectionTitle
          action={
            <Link to="/profilo" className="text-sm font-medium text-bordeaux hover:underline">
              Gestisci seguiti →
            </Link>
          }
        >
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div>
          <SectionTitle
            action={
              <Link to="/community" className="text-sm font-medium text-bordeaux hover:underline">
                Vai →
              </Link>
            }
          >
        ...
        <div>
          <SectionTitle
            action={
              <Link to="/notifiche" className="text-sm font-medium text-bordeaux hover:underline">
                Tutte →
              </Link>
            }
          >
      ...
      <section>
        <SectionTitle
          action={
            <Link to="/cantina" className="text-sm font-medium text-bordeaux hover:underline">
              Apri cantina →
            </Link>
          }
        >
