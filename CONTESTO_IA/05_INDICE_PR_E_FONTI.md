...
| [#34](https://github.com/enricopuntog-cpu/vinae-progetto-0/pull/34) | 11-08-2026 | **aperta** | Fase 10 — specifica organizzativa e registrazione delle decisioni, **sola documentazione**: nessun file `.sql`, `.ts`, `.tsx`, `.py`, `.toml` o `.yml` toccato. Branch `docs/fase-10-specifica-ai`, **non** `migration/phase-10-ai-service`, che resta chiuso. Porta l'inventario dell'AI legacy, le cinque decisioni chiuse dalla sessione dell'11 agosto 2026, le otto proposte non confermate, e la verifica che le Edge Function le distribuisce il merge |
